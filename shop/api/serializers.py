...
from .models import Category, Discount, Producer, Promocode, Product, RegistredUser
...
class ProductSerializer(ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'name', 'description', 'producer', 'category', 'discount', 'price', 'articul', 'count_on_stock']
...
class LoginSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        if user is None:
            raise serializers.ValidationError('A user with this phone or password is not found')
